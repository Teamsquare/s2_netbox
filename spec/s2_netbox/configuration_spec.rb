...
describe S2Netbox::Configuration do
  ...
  describe 'clearing the configuration' do
    it 'should set the configuration to nil defaults' do
      ...
      expect(S2Netbox::Configuration.current.controller_url).to be_nil
      expect(S2Netbox::Configuration.current.sha_password).to be_nil
    end
  end
    ...
    context 'using sha_password' do
      context 'when a valid configuration is supplied' do
        ...
        it 'should store the controller_url' do
          ...
          expect(S2Netbox::Configuration.current.sha_password).to eq('some_password')
        end
        ...
        it 'should store the sha_password' do
          ...
          expect(S2Netbox::Configuration.current.controller_url).to eq('https://test-s2')
        end
      end
    ...
    context 'using username and password' do
      context 'when a valid configuration is supplied' do
        ...
        it 'should store the username' do
          ...
          expect(S2Netbox::Configuration.current.username).to eq('some_username')
        end
        ...
        it 'should store the password' do
          ...
          expect(S2Netbox::Configuration.current.password).to eq('some_password')
        end
      end
